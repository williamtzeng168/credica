// ============================================
// i18n-data.js — Credica 多語言文案
//
// R10' (2026-05) 狀態:
//  - zh-TW 已從本檔移除(預設語言由 HTML 直接顯示,不經 i18n loader)
//  - zh-CN / en / ja / vi / th 仍為 V1 文案(智慧名片時代)
//  - 語言切換器在 i18n.js 已暫時隱藏(buildSwitcher 不呼叫)
//
// 未來重啟國際版本時(R11'-i18n)需做:
//  1. 重寫 5 種語言對齊 V2 文案
//     (Recyclable Digital Pass / 活動 / 憑證 / 整合 QR)
//  2. 確認 about.html / tutorial.html / business.html /
//     enterprise.html / lifestyle.html 用到的 data-i18n keys
//     都有對應翻譯(R7'/R8' 加的新 keys 目前 5 語言皆缺)
//  3. 移除 V1 only keys(screen.graph_* / update.* / V1 group.* 等)
//  4. 重新啟用 i18n.js 內 buildSwitcher(lang) 呼叫
// ============================================
const I18N_DATA = {
  "zh-CN": {
    "meta": {
