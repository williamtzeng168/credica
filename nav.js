...
(function () {
  ...
  var CSS = [
    ...
    '.credica-nav{position:sticky;top:0;left:0;right:0;z-index:100;min-height:76px;padding:1rem 2.5rem;display:flex;align-items:center;justify-content:space-between;background:#F6F7F9;border-bottom:1px solid #D9DEE7;box-shadow:none;font-family:-apple-system,BlinkMacSystemFont,"SF Pro Text","PingFang TC","Noto Sans TC",system-ui,sans-serif}',
    ...
    '.credica-nav .nav-login{display:inline-flex;align-items:center;gap:0.4rem;margin-right:0.7rem;padding:0.6rem 1.3rem;background:transparent;color:#18233F;border:1px solid #D9DEE7;border-radius:6px;font-size:0.95rem;font-weight:600;text-decoration:none;transition:background 0.18s,box-shadow 0.18s}',
    '.credica-nav .nav-login:hover{background:#FFFFFF;box-shadow:0 8px 20px rgba(24,35,63,0.08)}',
    '.credica-nav .nav-login svg{width:16px;height:16px}',
    '.credica-nav .nav-dl{display:flex;align-items:center;gap:0.5rem;padding:0.6rem 1.4rem;background:#18233F;color:#fff;border:1px solid #18233F;border-radius:6px;font-size:0.95rem;font-weight:700;cursor:pointer;transition:background 0.18s,box-shadow 0.18s,transform 0.18s;text-decoration:none}',
    '.credica-nav .nav-dl:hover{background:#111A30;transform:translateY(-1px);box-shadow:0 12px 28px rgba(24,35,63,0.2)}',
    ...
    '.credica-mobile-menu{display:none;position:fixed;top:0;left:0;width:100%;height:100vh;background:#F6F7F9;z-index:999;flex-direction:column;justify-content:center;align-items:center;gap:32px;opacity:0;pointer-events:none;transition:opacity 0.24s ease;font-family:-apple-system,BlinkMacSystemFont,"SF Pro Text","PingFang TC","Noto Sans TC",system-ui,sans-serif}',
